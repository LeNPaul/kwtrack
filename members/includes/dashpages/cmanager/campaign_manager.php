...
<div class="row">
  <div class="col-12 col-sm-12 col-md-12 col-lg-12">
    ...
    <table id="campaign_manager" class="table table-light table-hover responsive row-border order-column nowrap" cellpadding="0" cellspacing="0" style="width:100%;"></table>
  </div>
</div>
