...
function cmCheckboxState($status) {
  if ($status == 'enabled') {
    ...
    return '<input type="checkbox" class="toggle-campaign-archive" data-toggle="toggle" data-size="mini" disabled />';
  }
}
...
function cmGetCampaignData($pdo, $user_id) {
  ...
  for ($i = 0; $i < count($result); $i++) {
    ...
    $budget =  '<div class="input-group input-group-xs">
                  ...
                  <div class="input-group-append">
                    <button class="btn btn-success btn-outline-secondary btn-edit-budget" type="button">Save</button>
                  </div>
                </div>';
