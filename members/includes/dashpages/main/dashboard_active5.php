...
$adSpend = calculateMetrics(multiUnserialize(getMetricData($pdo, 'ad_spend', 2)), 2, 'adSpend');
$ppcSales = calculateMetrics(multiUnserialize(getMetricData($pdo, 'sales', 2)), 2, 'ppcSales');
