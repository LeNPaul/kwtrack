	...
	<div class="col-lg-12 col-md-12 col-sm-12">
      ...
      <div class="card-body">
			...
			<div class="chartWrapper" width="1000" height="400" style="position: relative">
				<canvas id="dummy" width="1000" height="400" style="position: relative"></canvas>
				<canvas id="cursor" width="1000" height="400" style="top:0; left:0; position: relative"></canvas>
				<canvas id="tooltips" width="1000" height="400" style="top:0;, left:0;, position: relative"></canvas>
				<canvas id="lineChart" width="1000" height="400" style="top:0; left:0; position: relative"></canvas>
			</div>
	  </div>
