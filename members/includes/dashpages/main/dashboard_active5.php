...
$adSpend = calculateMetrics(multiUnserialize(getMetricData($pdo, 'ad_spend', 2)), 6, 'adSpend');
$ppcSales = calculateMetrics(multiUnserialize(getMetricData($pdo, 'sales', 2)), 6, 'ppcSales');
